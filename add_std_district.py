...
# 2026-06-25 审计 P2-4 修复: 320903 是盐都区（不是盐南高新区）.
#   320903 错标 '盐南' 导致 256 条 yancheng_gov+ycggzy 记录被误归盐南.
#   ycggzy 爬虫 _area_to_region 映射: 320903='盐都区', 320971='盐南高新区'.
#   320992 实际行政代码里不存在 (历史遗留), 但 320971 才是盐南高新区真实代码.
CODE_MAP = [
    ("320901", "亭湖"),
    ("320902", "盐都"),
    ("320903", "盐都"),  # P2-4 修复: 错标 '盐南' 实际是 '盐都区'
    ("320904", "大丰"),
    ("320921", "响水"),
    ("320922", "滨海"),
    ("320923", "阜宁"),
    ...
    ("320925", "建湖"),
    ("320941", "经开"),
    ("320971", "盐南"),  # P2-4 修复: 新增 320971 盐南高新区 (ycggzy API 实际用此代码)
    ("320981", "东台"),
    ("320992", "盐南"),  # 兼容历史数据 (320992 行政代码里不存在, 是历史遗留)
]
